...
function DrawingDetail({ user }){
  ...
  const deleteButton = <button id="delete-button" onClick={handleDelete}>Delete Drawing</button>
  ...
  return(
    <div className="drawing-detail">
      <img className="detail-image" src={currentDrawing.image_url}  alt={`drawing by ${currentDrawing.title}`}/>
