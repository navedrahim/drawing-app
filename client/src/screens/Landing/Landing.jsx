        ...
        <main className="landing-main">
          ...
          <div className="main-text">
            <p className="description">
              ...
              color picker. Click on a circle to assign the selected color.{" "}
              <br />
              <br />
              Toggle the back-lighting with the Light button. The Reset button
              will clear the grid of all colored circles. <br />
              <br />
              When you are finished, click Save to add your design to the
              DrawBrite gallery!
            </p>
          </div>
          ...
          <div className="card-container">
            <div className="card">
              ...
              <div className="statement-container">
                <p>
                  I am a full stack developer with a penchant for learning new
                  skills and technologies. Due to my background as a pharmacist,
                  I have extensive experience in delivering optimal outcomes for
                  both the customer and business side. This, along with my track
                  record of meeting goals under pressure and working with teams
              ...
              <div className="landing-links">
                ...
                <a
                  href="https://www.linkedin.com/in/naved-rahim/"
                  target="_blank"
                >
                  <img
                    className="icon"
            ...
            <div className="card">
              ...
              <img
                className="pic"
                src="https://i.imgur.com/YZ1YPJt.png"
                alt="Nicholas"
              />
              <div className="statement-container">
                <p>
                  I am a software engineer who loves problem solving and
